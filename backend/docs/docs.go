...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/appointments/available-slots": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Duration in minutes (45 or 60)",
                        "name": "duration",
                        "in": "query",
                        "required": true
                    }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.CancelAppointmentRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.ConfirmAppointmentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/employees/specialty/{specialty}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.CreateExpenseCategoryRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/billing/expense-categories/parents": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/billing/expense-categories/tree": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.ExpenseCategoryWithChildren"
                            }
                        }
                    }
                }
        ...
        "/billing/expense-categories/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.UpdateExpenseCategoryRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid ID or has associated expenses",
                        "schema": {
                            "$ref": "#/definitions/handler.ErrorResponse"
                        }
                    },
        ...
        "/billing/expense-categories/{id}/subcategories": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/billing/expenses": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Has invoice (true/false)",
                        "name": "hasInvoice",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Supplier name (partial match)",
                        "name": "supplier",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Search in supplier, invoice, notes",
                        "name": "search",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/service.CategoryExpense"
                            }
                        }
                    },
                    "400": {
        ...
        "/billing/expenses/category/{categoryId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/billing/expenses/supplier/{supplier}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/billing/invoices": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Invoice status (paid/unpaid)",
                        "name": "status",
                        "in": "query"
                    },
                    {
        ...
        "/billing/invoices/number/{invoiceNumber}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Invoice Number (F_YYYY_NNNN)",
                        "name": "invoiceNumber",
                        "in": "path",
                        "required": true
                    }
        ...
        "/billing/invoices/{id}/mark-paid": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid ID or already paid",
                        "schema": {
                            "$ref": "#/definitions/handler.ErrorResponse"
                        }
                    },
    ...
    "definitions": {
        ...
        "domain.Appointment": {
            ...
            "properties": {
                "cancellationReason": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/domain.NullableString"
                        }
                    ]
                },
                "client": {
                ...
                "employee": {
                    "description": "Relations (not in DB)",
                    "allOf": [
                        {
                            "$ref": "#/definitions/domain.Employee"
                        }
        ...
        "domain.CancelAppointmentRequest": {
            "type": "object",
            "required": [
                "reason"
            ],
        ...
        "domain.ConfirmAppointmentRequest": {
            "type": "object",
            "properties": {
                "notes": {
                    "type": "string"
        ...
        "domain.CreateAppointmentRequest": {
            ...
            "properties": {
                "clientId": {
                    "description": "Optional: For admin/employee creating appointments for others",
                    "type": "string"
                },
                "description": {
                    "type": "string"
        ...
        "domain.DashboardStats": {
            ...
            "properties": {
                "appointments": {
                    "$ref": "#/definitions/domain.AppointmentStats"
                },
                "clients": {
                    "$ref": "#/definitions/domain.ClientStats"
                },
                "employees": {
                    "$ref": "#/definitions/domain.EmployeeStats"
                }
            }
        },
        "domain.Employee": {
        ...
        "domain.Expense": {
            ...
            "properties": {
                ...
                "attachmentPath": {
                    "description": "PDF path (si existe)",
                    "type": "string"
                },
                "category": {
                    "description": "Relationships (populated via joins, not stored in DB)",
                    "allOf": [
                        {
                            "$ref": "#/definitions/domain.ExpenseCategory"
                        }
                ...
                "supplierInvoice": {
                    "description": "Nº Factura emisor (opcional)",
                    "type": "string"
                },
                "updatedAt": {
                    "type": "string"
        ...
        "domain.ExpenseCategory": {
            ...
            "properties": {
                ...
                "parentId": {
                    "description": "Null for categories, set for subcategories",
                    "type": "string"
                },
                "sortOrder": {
                    "description": "For ordering in UI",
                    "type": "integer"
                },
                "subcategories": {
                    "type": "array",
        ...
        "domain.ExpenseCategoryWithChildren": {
            "type": "object",
            "properties": {
                "children": {
                    "type": "array",
        ...
        "domain.Invoice": {
            ...
            "properties": {
                ...
                "appointmentId": {
                    "description": "Nullable for manual invoices",
                    "type": "string"
                },
                "baseAmount": {
                ...
                "totalAmount": {
                    "description": "BaseAmount + VATAmount",
                    "type": "number"
                },
                "updatedAt": {
                    "type": "string"
        ...
        "domain.InvoiceStatus": {
            ...
            "x-enum-comments": {
                "InvoiceStatusPaid": "Cobrado",
                "InvoiceStatusUnpaid": "No Cobrado"
            },
            "x-enum-descriptions": [
                "Cobrado",
                "No Cobrado"
        ...
        "service.CreateEmployeeRequest": {
            ...
            "properties": {
                ...
                "specialty": {
                    "description": "Single specialty, converted to array internally",
                    "type": "string"
                },
                "userId": {
                    "type": "string"
        ...
        "service.CreateExpenseCategoryRequest": {
            "type": "object",
            "required": [
                "name"
            ],
            "properties": {
                ...
                "parentId": {
                    "description": "Null for parent categories",
                    "type": "string"
                },
                "sortOrder": {
                    "type": "integer"
        ...
        "service.DashboardStats": {
            ...
            "properties": {
                ...
                "recentInvoices": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/service.InvoiceSummary"
                    }
                },
                "revenueByMonth": {
                    "type": "array",
        ...
        "service.UpdateExpenseCategoryRequest": {
            "type": "object",
            "required": [
                "name"
            ],
